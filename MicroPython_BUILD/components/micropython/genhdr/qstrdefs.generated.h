...
QDEF(MP_QSTR_7sgcolor, (const byte*)"\x1b\x20\x08" "7sgcolor")
QDEF(MP_QSTR_7sgdist, (const byte*)"\x8c\x94\x07" "7sgdist")
QDEF(MP_QSTR_7sgoutline, (const byte*)"\x66\x04\x0a" "7sgoutline")
QDEF(MP_QSTR_7sgwidth, (const byte*)"\xa0\x5d\x08" "7sgwidth")
...
QDEF(MP_QSTR_FONT_Dejavu24, (const byte*)"\x66\x1c\x0d" "FONT_Dejavu24")
...
QDEF(MP_QSTR_HWI2C, (const byte*)"\xe2\x09\x05" "HWI2C")
...
QDEF(MP_QSTR_hwI2C, (const byte*)"\x22\x1c\x05" "hwI2C")
...
QDEF(MP_QSTR_kill, (const byte*)"\x67\x02\x04" "kill")
...
QDEF(MP_QSTR_pass, (const byte*)"\xb4\xcf\x04" "pass")
...
QDEF(MP_QSTR_resetclipwin, (const byte*)"\x16\x02\x0c" "resetclipwin")
QDEF(MP_QSTR_restoreclipwin, (const byte*)"\x0b\x1d\x0e" "restoreclipwin")
...
QDEF(MP_QSTR_rmtchan, (const byte*)"\xaa\x5c\x07" "rmtchan")
...
QDEF(MP_QSTR_rtcmem_read, (const byte*)"\x88\xe7\x0b" "rtcmem_read")
QDEF(MP_QSTR_rtcmem_read_string, (const byte*)"\xa2\x9c\x12" "rtcmem_read_string")
QDEF(MP_QSTR_rtcmem_write, (const byte*)"\x47\x40\x0c" "rtcmem_write")
QDEF(MP_QSTR_rtcmem_write_string, (const byte*)"\x8d\xcb\x13" "rtcmem_write_string")
...
QDEF(MP_QSTR_saveclipwin, (const byte*)"\xe2\x6b\x0b" "saveclipwin")
...
QDEF(MP_QSTR_setclipwin, (const byte*)"\xc1\xf3\x0a" "setclipwin")
...
QDEF(MP_QSTR_swI2C, (const byte*)"\xf9\x05\x05" "swI2C")

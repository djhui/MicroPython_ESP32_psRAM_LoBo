...
QDEF(MP_QSTR_SD_1LINE, (const byte*)"\x32\x50\x08" "SD_1LINE")
QDEF(MP_QSTR_SD_4LINE, (const byte*)"\x37\x50\x08" "SD_4LINE")
...
QDEF(MP_QSTR_flash_sec_size, (const byte*)"\x05\x23\x0e" "flash_sec_size")
...
QDEF(MP_QSTR_free_heap, (const byte*)"\x72\x51\x09" "free_heap")
...
QDEF(MP_QSTR_sdcard_init, (const byte*)"\xc3\x08\x0b" "sdcard_init")
QDEF(MP_QSTR_sdcard_read, (const byte*)"\x6b\xe4\x0b" "sdcard_read")
QDEF(MP_QSTR_sdcard_sect_count, (const byte*)"\x24\xa4\x11" "sdcard_sect_count")
QDEF(MP_QSTR_sdcard_sect_size, (const byte*)"\x62\x13\x10" "sdcard_sect_size")
QDEF(MP_QSTR_sdcard_write, (const byte*)"\x44\xaf\x0c" "sdcard_write")
...
QDEF(MP_QSTR_stdin_give, (const byte*)"\xe3\x71\x0a" "stdin_give")
QDEF(MP_QSTR_stdin_take, (const byte*)"\xe5\x41\x0a" "stdin_take")
...
QDEF(MP_QSTR_vfstype, (const byte*)"\x1e\x95\x07" "vfstype")

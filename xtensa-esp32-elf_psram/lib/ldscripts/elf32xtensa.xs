...
ENTRY(_start)
SEARCH_DIR("=/home/LoBo2_Razno/ESP32/crosstool-NG_psram/builds/xtensa-esp32-elf/xtensa-esp32-elf/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
